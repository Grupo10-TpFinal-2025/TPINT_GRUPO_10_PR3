        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hlListarDisponibilidades" runat="server" Font-Size="Large">Listar Disponibilidades</asp:HyperLink>
                    </td>
                </tr>
            </table>
            <br />
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style3" style="font-size: small; text-decoration: blink">&nbsp;&nbsp;&nbsp; Día:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:DropDownList ID="ddlDiasDis" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style6" style="font-size: small; text-decoration: blink">&nbsp;&nbsp;&nbsp; Horario de Finalización:&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlHorarioFinDis" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
