        ...
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hlListarPacientes" runat="server" Font-Size="Large">Listar Pacientes</asp:HyperLink>
                    </td>
                </tr>
            </table>
            <br />
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="lblTituloAltaPaciente" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Baja de Paciente:"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            ...
            <table class="auto-style9">
                <tr>
                    <td class="auto-style7">
                        DNI Paciente:&nbsp;<asp:TextBox ID="txtLejajoBajaMedico" runat="server"></asp:TextBox>
